                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="subcategory_id" id="subCategoryId">
                                    <option value="" disabled selected>-- selected SubCategory --</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="brand_id">
                                    <option value="" disabled selected>-- selected Brand --</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="unit_id">
                                    <option value="" disabled selected>-- selected Unit --</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="stock_amount" id="exampleInputuname3" placeholder="Product Stock Amount">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <div class="input-group">
                                   ...
                                   <input type="text" class="form-control" name="selling_price" id="exampleInputuname3" placeholder="Selling  Price">
                               </div>
                            </div>
                        </div>
